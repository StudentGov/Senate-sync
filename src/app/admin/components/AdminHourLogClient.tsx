  ...
  return (
    <div className="p-4">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="text-sm text-gray-600">Target per period: {targetHours} hrs</div>
      </div>
      ...
      {sortedKeys.map((pkey) => {
        ...
        return (
          <section key={pkey} className="mb-6 bg-white rounded shadow p-3">
            <h3 className="text-md font-medium mb-2">Period starting {periodStart}</h3>
                  ...
                  <tbody>
                    {users.map(([uid, meta]) => (
                      <tr key={uid} className="border-b">
                        ...
                        <td className="py-2 px-3 align-top text-sm">{meta.total >= targetHours ? <span className="text-green-600 font-medium">Met</span> : <span className="text-red-600 font-medium">Missing</span>}</td>
