...
export default function HomePage() {
  return (
    <div className="bg-white flex flex-col items-center min-h-screen w-full overflow-x-hidden">
      {/* Hero Section */}
      <section className="homepage-hero-section-container relative w-full h-[500px] flex items-start justify-start overflow-hidden">
        <img
          src={imgCampusClockTower1}
          alt="Campus Clock Tower"
          className="hero-section-background-image absolute inset-0 w-full h-full object-cover object-center"
        />
        ...
        <div className="relative z-10 flex flex-col items-start max-w-4xl ml-12 pt-24 pb-8">
          <h1 className="text-5xl md:text-6xl font-kanit text-white mb-6">
            Student Government
          </h1>
          <p className="text-xl text-white/90 mb-8 max-w-xl font-kanit">
          ...
          <div className="flex gap-4">
            <a
              href="/attorney"
              className="bg-[#febd11] text-white rounded-lg px-8 py-3 font-kanit text-lg hover:bg-[#e6a900] transition"
            >
              Schedule Appointment
            </a>
            <a
              href="#learn-more"
              className="border-2 border-white text-white rounded-lg px-8 py-3 font-kanit text-lg hover:bg-white hover:text-[#49306e] transition"
            >
              Learn More
            </a>
          </div>
      ...
      <section className="w-full bg-white py-20" id="team">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-kanit text-[#49306e] mb-2">
          ...
          <div className="flex flex-col md:flex-row gap-8 justify-center">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 flex-1 flex flex-col items-center transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_8px_30px_rgba(254,189,17,0.4)] cursor-pointer border-2 border-transparent hover:border-[#febd11]">
              ...
              />
              <h3 className="text-xl font-kanit text-[#49306e]">
                Andrew Colleran
              </h3>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row gap-8 justify-center">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 flex-1 flex flex-col items-center transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_8px_30px_rgba(254,189,17,0.4)] cursor-pointer border-2 border-transparent hover:border-[#febd11]">
              ...
              <h3 className="text-2xl font-kanit text-[#49306e] mb-2">
                Students
              </h3>
      ...
      <section className="w-full bg-[#49306e] py-20" id="contact">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-4xl font-kanit font-normal text-white text-center mb-3">
            Any feedback or Issues?
          </h2>
          <p className="text-white/90 text-center mb-12 font-kanit text-lg">
          ...
          <div className="flex flex-col md:flex-row gap-0 items-stretch max-w-5xl mx-auto">
            ...
            <div className="flex-1 md:pr-12">
              <form className="space-y-6">
                <div>
                  <label className="block text-white font-kanit mb-2">
                    Name
                  </label>
                  <input
                    type="text"
            ...
            {/* Yellow Divider Line */}
            <div
              className="hidden md:block w-px bg-[#febd11] mx-8 self-stretch"
              style={{ width: "2px" }}
            ></div>
